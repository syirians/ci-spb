...
class Pengguna extends SB_Controller 
{
	...
	function index() 
	{
		...
		$this->data['content'] = $this->load->view('pengguna/index',$this->data, true );
	...
	function show( $id = null) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] =  $this->load->view('pengguna/view', $this->data ,true);	  
		$this->load->view('layouts/main',$this->data);
	}
	...
	function add( $id = null ) 
	{
		...
		$this->data['id'] = $id;
		$this->data['content'] = $this->load->view('pengguna/form',$this->data, true );		
	  	$this->load->view('layouts/main', $this->data );
...
// 			$ID = $this->model->insertRow($data , $this->input->get_post( 'id' , true ));
			...
			{
				redirect( 'pengguna/add/'.$ID,301);
			} else {
				redirect( 'pengguna',301);
			}				
	}
