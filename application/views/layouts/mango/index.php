	...
	<div class="container">
		<div class="navbar navbar-default ">			
				<div class="navbar-header">
					...
					<img src="<?php echo base_url().'sximo/themes/mango/img/spb.png'?>" class="img-responsive" width="70" height="70" />
...
<div id="footer">
	<div class=" container">
		<div class="col-md-7"> Copyright 2018 <?php echo CNF_APPNAME ?></div>
